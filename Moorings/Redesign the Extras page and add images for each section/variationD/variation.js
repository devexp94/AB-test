...
`;
        ...
        function init() {
            ...
            document.querySelectorAll('.booking-flow .main .extra.child').forEach(function(el) {
                ...
                el.previousElementSibling.querySelector('.price-quantity').insertAdjacentHTML('beforeend', '<div class="eg_withProvision"><label><input type="checkbox"> With Provision</label><span class="eg_totalPrice"> $' + totalPriceWithProvision + '</span></div>')
            })
            ...
            document.querySelectorAll('.eg_withProvision label input').forEach(function(el) {
                ...
                el.addEventListener('click', function(element) {
                    ...
                    el.closest('.extra').querySelector('.extra-line-item > label input').click();
        ...
        function movingElements(elements) {
            elements.forEach(ele => {
                ...
                if (qualifier) {
                    ...
                    priceQuantity.insertAdjacentHTML('afterbegin', '<label class="eg_withoutProvision"><input type="checkbox" class="eg_withoutProvision"> Without Provision</label>')
                }
