  ...
  try {
    ...
    function firstStepValidation() {
      ...
      var op2 = document.querySelector('#container_what_is_your_ideal_holiday_type select').value;
      var op3 = document.querySelector('#container_no_of_travellers select').value;
      var op4 = document.querySelector('#container_budget_per_person select').value;
      if (op1.length && op2.length && op3.length && op4.length) {
        return true;
      }
      else {
        false;
