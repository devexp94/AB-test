(function () {
  try {
    ...
    '                  <div id="bannerword">'+ 
    '                      <h1 class="banner_title banner_title2">Send money </br>overseas </br>Fast. Simple.</h1>'+ 
    '                  </div>'+ 
    '                  <div class="bannerDesc">'+ 
    '                      <p class="banner_desc banner_desc2">Download the Instarem app, use the code 3FREE and enjoy zero fees on your first 3 transfers.'+ 
    '                      </p>'+ 
    '                  </div>'+ 
