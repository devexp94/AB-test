(function () {
  try {
    ...
    '           <a href="#" class="eg-btn">Search by Rego</a>'+
    '           <a href="#" class="eg-btn">Search by Size</a>'+
    '          </div>'+ 
    '      </div>'+ 
    '      </div>'+ 
    '  </div>';
    ...
    function init() {
      ...
      document.querySelector('.eg-hero .eg-button-container a:last-of-type').addEventListener('click',function(e){
        e.preventDefault();
        document.querySelector(".tyreWidget .tyreWidget-bar-buttons_btn.-tyre").click();
      });
    }
