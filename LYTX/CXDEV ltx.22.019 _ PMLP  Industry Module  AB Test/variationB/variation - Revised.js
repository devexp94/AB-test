(function () {
  try {
    ...
    function init() {
      ...
      document.querySelector('select#eg-filter-vehicle').addEventListener('change',function(){
        var val= this.value;
        //console.log(val, 'sff',document.querySelector('.eg-filter-options figure[data-cs-vehicle="'+val+'"]'));
        document.querySelector('.eg-filter-options figure[data-cs-vehicle].filtered--show').classList.add('filtered--hide');
        document.querySelector('.eg-filter-options figure[data-cs-vehicle].filtered--show').classList.remove('filtered--show');
        document.querySelector('.eg-filter-options figure[data-cs-vehicle="'+val+'"]').classList.add('filtered--show');
        document.querySelector('.eg-filter-options figure[data-cs-vehicle="'+val+'"]').classList.remove('filtered--hide');
      });
    }
...
.eg-industries-section-inr {
    display: flex;
}

.eg-industries-section-inr .eg-industries-image {
    width: 66%;
}

.eg-industries-section-inr .eg-industries-content {
    width: 33%;
    padding-right: 2rem;
}
...
html body .eg-industries-section .eg-para {
    color: #fff;
    margin-top: 1.5em;
    margin-bottom: 0px;
}

.eg-industries-section .eg-filter label {
    margin-top: 2rem;
    margin-bottom: 0.8rem;
    font-size: .875rem;
    
}
.eg-industries-section select#eg-filter-vehicle {
    ...
    color: #fff;
    font-weight: 600;
    background-image: url('https://www.lytx.com/App_Themes/TurnWithUs/public/images/icon-arrow-down-white.svg');
...
@media screen and (max-width:895px) {
    html body .full-width-video-wrapper {
        margin-top: 0px !important;
    }
    html body .eg-industries-section-inr .eg-industries-content {
        width: 100%;
        padding-right: 0px;
    }   
    html body .eg-industries-section-inr .eg-industries-image{
        margin-top: 2rem;
        width: 100%;
    }
    html body .eg-industries-section-inr {
        flex-direction: column;
    }
    html body .eg-industries-section .eg-heading {
    ...
    .eg-industries-section .container {
        padding: 0 1rem;
    }
}