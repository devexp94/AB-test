...
'              </div>'; 
    ...
    '              <span id="africa" class="sub-option">Africa</span>'+ 
    ...
    '          </div>'+ 
    '          <!-- Tab-1 -->'+ 
    '          <div class="sub-nav-content" id="africa">'+ 
    '              <div class="left-content">'+ 
    '              <div class="left-content-inr">'+ 
    '                  <ul class="tab-1">'+ 
    '                      <li><a href="/holidays/morocco/">Morocco</a></li>'+ 
    '                  </ul>'+ 
    '              </div></div>'+  rightContent+ 
    '          </div>'+ 
    '      </div>'+ 
    ...
    '              </div></div>'+  
    '              <div class="right-content">'+ 
    '             <a href="/holiday-types/family-holidays/">'+
'                  <div class="image">'+ 
...
'              </div>'+ 
    ...
    '              </div></div>'+
    '              <div class="right-content">'+ 
    '               <a href="/holiday-offers/last-minute-holiday-offers/">'+
'                  <div class="image">'+ 
...
'                  </div>'+ 
'                  <div class="text-content">'+ 
'                      <h3 class="heading">Travel with Confidence</h3>'+ 
...
'              </div>'+ 
 ...
 function chnageMobile(){
  //.navbar-header_container.container > button span +span
