(function() {
  try {
      ...
      function init() {
          ...
          let egTrustLogosDiv = '<div class="eg-wrapper"><div class="eg-trust-title"><h2>Trusted By Companies Worldwide For Over 35 Years</h2></div><div class="eg-trust-logos">';
