...
(function () {
  try {
    ...
    '              <img src="https://glb-oned-cdn-prod.azureedge.net/-/media/Waterford/Images/Sales/2022/summer-sale-uk/sale-timer/summer_sale_product_page_banner_desktop_copy">'+
    '          </div>'+ 
    '      </div>'+ 
    '  </div>';
