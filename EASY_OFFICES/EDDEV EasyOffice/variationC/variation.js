(function () {
    try {
        ...
        function initVariation() {
            ...
            //   }
            document.querySelector('.eg-sort-by').addEventListener('mousedown', function () {
                console.log('sdad')
                setTimeout(function () {
                    document.querySelector('.filter-link.filter-link-sort').click();
                }, 100);

            });
            document.querySelector('.eg-more-filters').addEventListener('click', function () {
                setTimeout(function () {
                    document.querySelector('.filter-facilities a.filter-link').click();
                }, 100);
            });
            //eg-facilities
            document.querySelector('.eg-facilities').addEventListener('click', function () {
                setTimeout(function () {
                    document.querySelector('a.filter-link.js-get-relevant-distance').click();
                }, 100);
            });
        }
