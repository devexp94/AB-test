(function () {
  try {
      ...
      document.querySelectorAll('.std > section.mps-media a.button').forEach(function(item) {
        item.addEventListener('click', function(e) {
          ...
          document.querySelector('svg.col-close').addEventListener('click', function() {
            ...
            document.querySelector('#col-content').style.display = "none";
            document.querySelector('#col-content').setAttribute('src', '');
           
          });
          document.querySelector('.col-show.col-popup-wrapper .col-popup-overlay').addEventListener('click', function() {
            document.querySelector('.col-popup-wrapper').classList.remove('col-show')
            document.querySelector('.lds-roller').style.display = "block";
            document.querySelector('#col-content').style.display = "none";
            document.querySelector('#col-content').setAttribute('src', '');
    ...
    waitForElement(".std > section.mps-media a.button", init, 50, 15000);
  } catch (e) {
