(function () {
  try {
    ...
    '              <h2 class="banner-heading">SUMMER SALE </br>NOW ON</h2>'+ 
    '              <p class="banner-subheading">20% OFF SITEWIDE*</p>'+ 
    '          </div>'+ 
    '          <div class="eg-promo-timer">'+ 
    '              <h3 class="promo-heading">HURRY, SUMMER </br>SALE ENDS IN</h3>'+ 
    ...
    function pdp() {
      ...
      setInterval(function () {
        ...
        var egEndDate = new Date('July 24 2022 23:59:59 GMT+1300').getTime();
    ...
    '  <div class="eg-sale-banner">'+ 
    '      <div class="banner-content">'+ 
    '          <h2 class="banner-heading">SUMMER </br>SALE </br>NOW ON</h2>'+ 
    '          <p class="banner-subheading">20% OFF </br>SITEWIDE*</p>'+ 
    '      </div>'+ 
    '      <div class="eg-promo-timer">'+ 
    '          <h3 class="promo-heading">HURRY, SUMMER SALE ENDS IN</h3>'+ 
    '          <div class="eg-promo-timer-inr">'+ 
    '              <div class="eg-date eg-box">'+ 
    '                  <span class="eg-number">00</span>'+ 
    '                  <span class="eg-text">Days</span>'+ 
