(function () {
  try {
    ...
    '          <p class="eg-author"><img src="https://cfactory-img.s3.amazonaws.com/VDFU/10.0/starsw.svg" atl="star Rating"> -Henry Williams from <a href="http://startups.co.uk/" rel="noopener" target="_blank"> Startups.co.uk.</a></p>'+ 
    '      </div>'+ 
    '      </div>'+ 
    '      </div>'+ 
    '  </div>';
