...
//<iframe src="https://player.vimeo.com/video/737882682?h=e026e88672" width="640" height="564" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
   var videoData ={
    ...
    function init() {
      ...
      var egVideo =''+ 
      '  <div class="eg-video-section" id="eg-action-video">'+ 
      ...
      '  </div>';
        ...
        document.querySelector('#tool-tips, .product-section.product-tooltips').insertAdjacentHTML('afterend', egVideo);
    }
    ...
    waitForElement(".product.attribute.overview", init, 100, 25000);
    waitForElement(".product-info-main #prod-descriptions #tool-care", init2, 100, 25000);
  } catch (e) {
