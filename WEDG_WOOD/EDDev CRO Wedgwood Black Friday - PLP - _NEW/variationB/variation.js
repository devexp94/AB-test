(function () {
    try {
      ...
      function init() {
        document.querySelector('.c-c-pl_products .c-c-product-card:nth-child(1)').addEventListener('click', function(e){
          e.preventDefault();
      ...
      waitForElement(".c-c-pl_products .c-c-product-card:nth-child(1)", init, 100, 25000);
