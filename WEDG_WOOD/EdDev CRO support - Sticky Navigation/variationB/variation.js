...
//       '      <!---->'+ 
//       '  </div>'+
//       '              <p class="eg-sub-heading">Elevate your festive experience</p>'+ 
//       '              <p class="eg-heading">Dress the tree</p>'+ 
//       '              <button class="eg-button c-btn primary">Shop Christmas Decorations</button>'+ 
//       '          </div>'+ 
//       '      </a>'+ 
//       '  </li>';
...
//           document.querySelector('.eg-gift-link').setAttribute('href', 'https://www.wedgwood.com/en-gb/home-decor/christmas-decorations-and-ornaments/christmas-decorations');
 
//          }else if(window.location.pathname.indexOf('/en-us/') != -1){
 
//            document.querySelector('.eg-gift-link').setAttribute('href', 'https://www.wedgwood.com/en-us/home-decor/christmas/christmas-decorations');
//          }
//       }
