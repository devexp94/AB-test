...
'  </svg>';
    ...
    '<h1 class="eg-hero-heading">8 Reasons Why <strong>EDR is Not Enough</strong> Prevention is possible!</h1>'+
    ...
    '  </ul>'+ 
    '  <p class="eg-para">'+ quoteIcon +' <span> If EDR was enough, we would see successful ransomware attacks decreasing, not increasing '+ quoteIcon +'</span></p>'+ 
    '  </div>'+ 
    '  </div>'+ 
...
'   </div></div>';
    ...
    function init() {
      ...
      setTimeout(function(){
        document.querySelector('form.hs-form .hs-button').setAttribute('value', 'Get Your eBook Now');
      }, 2000)
