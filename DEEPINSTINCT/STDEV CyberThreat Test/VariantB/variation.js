...
'  </svg>';
    ...
    '  <h2 class="eg-heading">Learn about the most significant cyber threats and trends from the past year</h2>'+ 
    '  <h2 class="eg-subheading">In this report, you will learn</h2>'+ 
    '  <ul class="eg-list">'+ 
    '      <li>' + tickMark + 'The most devastating malware and ransomware and how to stop them</li>'+ 
    '      <li>' + tickMark + 'How malware including IcedID, Qakbot, Dridex and Trickbot target the financial sector</li>'+ 
    '      <li>' + tickMark + 'How & why threats are evolving to target higher-profile organizations</li>'+ 
    '      <li>' + tickMark + 'Why the large supply chain attacks of 2021 are only the beginning</li>'+ 
    '      <li>' + tickMark + 'How deep learning delivers the highest level of prevention available</li>'+ 
    '  </ul>'+ 
    '  </div>'+
    '  </div>'+
    ...
    '          <h1 class="eg-hero-heading">2022 Cyber Threat Landscape Report</h1>'+ 
    '          <p class="eg-hero-subheading">Better understand and prepare for threats and vulnerabilities to come!</p>'+ 
    '      </div>'+ 
    '  </div>';
